...
bashbash <(curl -s https://raw.githubusercontent.com/detective-noir-dev/Remnawave-Scripts/main/install.sh)
Run globally:
bashrw-scripts
⚙️ Uninstallation
